...
namespace Leap {
  ...
  /// <summary>
  /// The TargetedController class is your main interface to the Leap Motion TargetedController.
  /// 
  /// Create an instance of this TargetedController class to access frames of tracking
  /// data and configuration information.Frame data can be polled at any time
  /// using the TargetedController.Frame() function.Call frame() or frame(0) to get the
  ...
  public class Controller :
    ...
    /// <summary>
    /// Constructs a TargetedController object.
    /// 
    ...
    /// <summary>
    /// Constructs a TargetedController object using the specified connection key.
    /// 
    ...
    /// TargetedController.IsPolicySet() after a suitable interval to test whether 
    ...
    /// property. The data in Frame objects taken directly from a Leap.TargetedController instance
    ...
    /// <summary>
    /// Reports whether this TargetedController is connected to the Leap Motion service and
    /// the Leap Motion hardware is plugged in.
    /// 
    /// When you first create a TargetedController object, isConnected() returns false.
    ...
    /// tracking volume.
    /// 
    /// Currently, the Leap Motion TargetedController only allows a single active device at a time,

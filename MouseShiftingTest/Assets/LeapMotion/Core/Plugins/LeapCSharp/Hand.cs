...
namespace Leap {
  ...
  public class Hand : IEquatable<Hand> {
    ...
    /// or when it is withdrawn from or reaches the edge of the Leap Motion TargetedController field of view),
    ...
    /// <summary>
    /// The duration of time this Hand has been visible to the Leap Motion TargetedController.
    /// @since 1.0
    /// </summary>

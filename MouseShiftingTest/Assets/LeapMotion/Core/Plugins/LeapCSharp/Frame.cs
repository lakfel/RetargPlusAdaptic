...
namespace Leap {
  ...
  /// 
  /// Access Frame objects through an instance of the TargetedController class.
  /// @since 1.0
  /// </summary>
  [Serializable]
  public class Frame : IEquatable<Frame> {
    ...
    /// Get valid Frame objects by calling the TargetedController.Frame() function.
    /// 
    ...
    /// time in the past.
    /// 
    /// You can use TargetedController.Now() to calculate the age of the frame.
    /// 
    /// @since 1.0
    /// </summary>

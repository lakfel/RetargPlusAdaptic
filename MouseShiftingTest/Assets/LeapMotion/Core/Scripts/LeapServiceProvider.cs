...
namespace Leap.Unity {
  ...
  public class LeapServiceProvider : LeapProvider {
    ...
    /// <summary>
    /// Returns the Leap TargetedController instance.
    /// </summary>
    ...
    /// <summary>
    /// Creates an instance of a TargetedController, initializing its policy flags and
    ...
    /// <summary>
    /// Stops the connection for the existing instance of a TargetedController, clearing old
    /// policy flags and resetting the TargetedController to null.
    /// </summary>
